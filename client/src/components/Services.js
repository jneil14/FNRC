    ...
    <>
      <div className="services" id="services">
        ...
        <div className="services__info-odd">
          <h3 className="services__info-odd-name" id="celban">
            CELBAN
          </h3>
          <p className="services__info-odd-description">
            ...
            licensure in the nursing profession in Canada. CELBAN is recognized
            by nursing licensing bodies across Canada.
          </p>
        </div>
        {/* end of CELBAN section */}

        <div className="services__info-even">
          <h3 className="services__info-even-name" id="ncas">
            NCAS-RN and LPN
          </h3>
          <p className="services__info-even-description">
            ...
            uses a Computer-based Assessment (CBA), a Simulation Lab Assessment
        ...
        <div className="services__info-odd">
          <h3 className="services__info-odd-name" id="nclex">
            NCLEX-RN
          </h3>
          <p className="services__info-odd-description">
        ...
        <div className="services__info-even">
          <h3 className="services__info-even-name" id="cpnre">
            CPNRE
          </h3>
          <p className="services__info-even-description">
            All applicants seeking BCCNP registration must write and pass the{" "}
            <span className="services__info-even-description--bold">
              Canadian Practical Nurse Registration Examination for LPNs (CPNRE)
            </span>
            . This exam measures the competencies required of entry-level
            licensed practical nurses for safe and effective practice. CPNRE is
            a computer-based test (answer questions on a computer screen instead
            of paper).
          </p>
        </div>
        {/* end of CPNRE*/}
